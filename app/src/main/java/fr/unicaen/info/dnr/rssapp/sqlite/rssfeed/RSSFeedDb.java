...
import fr.unicaen.info.dnr.rssapp.fr.unicaen.info.dnr.rssapp.entity.RSSFeed;
...
public final class RSSFeedDb {
     ...
     * @param db : database.
     * @param link : Object RSSFeed.
     */
    public static void add(SQLiteDatabase db, RSSFeed link) {
        ContentValues values = new ContentValues();
        values.put(RSSFeedDbOperation.FeedEntry.COLUMN_NAME_LINK, link.getLink());
    ...
    public static List get(SQLiteDatabase db, String[] args) {
        ...
        while(cursor.moveToNext()) {
            long linkId = cursor.getLong(
                    cursor.getColumnIndexOrThrow(RSSFeedDbOperation.FeedEntry._ID));
